  ...
  return (
    isEmpty && (
      <div className="flex flex-col items-center justify-center h-96 text-center px-8 ">
        ...
        <h3 className="text-2xl font-semibold bg-gradient-to-r from-cyan-400 via-blue-400 to-purple-400 bg-clip-text text-transparent mb-3">
          Start Your Conversation
        </h3>
        <p className="text-white/70 text-lg max-w-md leading-relaxed">
          Send a message to begin your professional discussion. Your
